...
public class KartController2 : MonoBehaviour
{
    ...
    private void UpdateTriggerPosition( Collider collider, bool firstTrigger )
    {
        float num = 0.65f;
        {
            ...
            RaycastHit[] array = Physics.RaycastAll( ray, magnitude * 2f );
            ...
            if( flag3 )
            {
                ...
                {
                    bool flag5 = raycastHit2.normal.y > 0f && ( !flag4 || raycastHit2.distance < num2 );
                    if( flag5 )
                    {
                        num2 = raycastHit2.distance;
                        vector2 = raycastHit2.normal;
                        num4 = raycastHit2.collider.gameObject.layer;
                        flag4 = true;
                ...
                {
                    bool flag7 = false;
                    bool flag8 = magnitude - num2 > 0f;
                    if( flag8 )
                    {
                        _targetUpVector = vector2;
                        flag7 = true;
                    }
                    bool contact = m_Contact;
                    if( contact )
                    {
                        vector2 = m_sus.contactN;
                        _targetUpVector = vector2;
                        flag7 = true;
                    }
                    bool flag9 = flag7;
